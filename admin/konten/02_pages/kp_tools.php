...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">
    <a href="?p=KP_kelola_sidang">List Kerja Praktek</a>
  </li>
  <li class="breadcrumb-item active">
    <a href="?p=ta_detail&id=<?php echo $_GET['id']; ?>">KP Detail</a>
  </li>
  <li class="breadcrumb-item active">Pilih Tanggal Sidang</li>
</ol>
<!-- Area Dashboard-->
  ...
  <div class="row">
    <div class="col-lg-12">
      <form action="?a=daftar_aksi&tipe=sidang&ts=ta" method="post" class="form-inline">
        ...
        <input type="hidden" name="tipe_sidang" value="KP">
