  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <table class="table table-sm table-hover ">
        ...
        foreach ($sql_kp_detail as $key) {
          ...
          ?>
               <tr>
                   <th width="40%">NIM</th>
                   <td>:</td>
                   <td><input type="hidden" name="id" value="<?php echo $id_jadwal_kp; ?>" required><?php echo $nim; ?></td>
               </tr>
        ...
        <a href="?p=jadwal_tools&ts=kp&id=<?php echo $id; ?>&act=x" class="btn btn-danger btn-sm">
...
<div class="row">
  <div class="col-lg-12">
    <table class="table table-bordered table-hovered">
      ...
      <?php
      foreach ($sql_kp_absen_list as $key) {
        extract($key);
        ?>
          <tr>
