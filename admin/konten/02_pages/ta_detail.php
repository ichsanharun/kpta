...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">
    <a href="?p=TA_kelola_sidang">List Tugas Akhir</a>
  </li>
  <li class="breadcrumb-item active">TA Detail</li>
</ol>
<!-- Area Dashboard-->
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <table class="table table-sm table-hover ">
        ...
        <a href="?p=ta_detail" class="btn btn-secondary btn-sm">
          <i class="fa fa-fw fa-arrow-circle-left"></i>Kembali</a>
        <button type="submit" class="btn btn-success btn-sm">
          <i class="fa fa-fw fa-check-circle"></i>Setujui</a>
        </button>
        <a href="?p=ta_tools&id=<?php echo $id; ?>" class="btn btn-info btn-sm">
          <i class="fa fa-fw fa-calendar"></i>Pilih Waktu</a>
      </form>
    </div>
