      ...
      foreach ($sql_absen_ta_id as $key) {
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="?p=TA_absen_lihat&id=<?php echo $id_absen_ta; ?>" class="btn btn-info">Atur Jadwal</a>
              <a href="?p=TA_absen_kehadiran&id=<?php echo $id_absen_ta; ?>" class="btn btn-info">Kehadiran</a>
            </td>
          </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="?p=absen_aksi" method="POST" class="" enctype="multipart/form-data">
          <input name="tipe_absen" type="hidden" value="absen_ta">
