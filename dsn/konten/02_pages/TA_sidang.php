        ...
        ?>
          <tr>
            ...
            <td>
              ...
              <a href="?p=TA_kelola_nilai_sidang&id=<?php echo $ID; ?>" class="btn btn-primary btn-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-sm table-hover ">
          <?php
          $no = 0;
          $query_ta_sidang_penguji = "SELECT * FROM sidang_ta INNER JOIN sidang_ta_detail INNER JOIN dosen ON `sidang_ta`.`id_sidang_ta` = `sidang_ta_detail`.`id_sidang_ta` AND `sidang_ta_detail`.`id_dosen_penguji` = `dosen`.`id_dosen` WHERE `sidang_ta_detail`.`id_sidang_ta` = '$ID'";
